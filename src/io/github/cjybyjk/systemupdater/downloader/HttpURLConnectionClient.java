...
package io.github.cjybyjk.systemupdater.downloader;
...
public class HttpURLConnectionClient implements DownloadClient {
    ...
    HttpURLConnectionClient(String url, File destination, String userAgent,
    ...
    private class DownloadThread extends Thread {
        ...
        private void handleDuplicateLinks() throws IOException {
            ...
            for (; ; ) {
                try {
                    ...
                    mClient.setRequestProperty("User-Agent", mUserAgent);
                    mClient.connect();
        ...
        public void run() {
            try {
                ...
                File tDirectory = new File(mDestination.getParent());
                tDirectory.mkdirs();
                try (
